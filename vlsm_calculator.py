...
def main():
    ...
    imprimir_resultado("OFICINA CENTRAL - VLSM", central)
    imprimir_resultado("OFICINA REMOTA - VLSM", remota)
    imprimir_resultado("INTERNET - VLSM", internet)
    ...
    ruta = OUTPUT_DIR / "vlsm_plan.txt"
    ruta.write_text(contenido, encoding="utf-8")

    print(f"\nPlan VLSM guardado en: {ruta}")
